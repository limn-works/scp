...
> date this file carries, restored unedited. The identity model it reads — the DID document and its verification methods, the shared `#agent` key, Ed25519, the BEP44 record encoding and the identifier written as a `did:` string — was
