...
- **Enforcement:** a structural test enumerates every security-critical `PerContextState` field and asserts Class S or Class M; a new field defaulting to Class C fails CI.
