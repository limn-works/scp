...
## Amendment (2026-07-14): Recovery-authority residence — Accepted (2026-07-14, by maintainer delegation)

This amendment does not delete or contradict the design above; it sharpens the security property the design must satisfy, resolves OQ2 and OQ3, and **moves the ADR to Accepted**. The design is complete and review-converged; the maintainer explicitly delegated the acceptance decision, so this amendment records acceptance as of 2026-07-14 on that delegated authority. Provenance: the normative rule is authored spec-first as **§9.7.4.1 item 3a** in `../specs/09-security-model.md`; this ADR cites and realizes it, per the artifact-flow invariant. The rule is upstream; ADR-054 does not author it.
...
> **Resolution status (Amendment 2026-07-14):** OQ1 resolved by ADR-055 (below). **OQ2 resolved** — per-profile floors; see the Amendment section. **OQ3 resolved YES** — §9.7.4.1 item 3a authored spec-first; see the Amendment section. All open questions are now resolved; the ADR is **Accepted (2026-07-14), on the maintainer's delegated acceptance**.
