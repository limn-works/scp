...
export class UcanPermissionError extends ScpError { override name = "UcanPermissionError" as const; }
...
5. **UCAN API:**
   ...
   - `revokeUcan(ctx, tokenId)` revokes the token; subsequent validation throws `UcanPermissionError`.
