...
§3.9 of the identity specification governs the four DID keys and states, for each one, where its key material lives and who chooses that.

```
Identity Key (Ed25519, strongest custody the platform offers)
...
│
Pre-Rotation Key (Ed25519, cold storage, isolated from operational custody)
├── SHA-256(pubkey) published as commitment
├── Revealed only during Identity Key migration, becoming the new Identity Key
│
