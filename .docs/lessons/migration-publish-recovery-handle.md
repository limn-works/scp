...
- `.docs/specs/09-security-model.md` §9.7.4.1 — Partial-publish recovery paragraph.
- `.docs/adrs/phase-1.md` §4b — Partial-publish recovery bullet.
- `.docs/adrs/phase-1.md` ADR-046 — Byte-parity invariant.
