...
Actor DID (did:dht:<z-base-32(pubkey)>, shown below in the 53-character form the code emits today; §18.2.2A fixes the format at 52 characters with no prepended `z`, and these fixtures are regenerated by the DID-string slice that lands that fix):
