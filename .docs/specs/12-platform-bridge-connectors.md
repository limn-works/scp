...
2. On governance approval, the context appends a `BridgeRegistrationEvent` leaf with `action: Revoked` to its Merkle event log (bridge registration wire table, §12.12.2).
