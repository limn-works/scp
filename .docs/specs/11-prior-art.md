...
| Storage duration | Demand-driven LRU; unpopular content expires | A key-event record carries no TTL, and a validating relay's ring buffer is what removes one (`09-security-model.md` §9.7.4.2 R9); context-governed for messages |
