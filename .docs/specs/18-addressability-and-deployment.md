...
| `rent.price` | integer | smallest unit | The price of one unit of rent as `Amount` in the smallest unit of `economic.currency` (§19.1.1). |
| `rent.period_seconds` | integer | seconds | The duration one unit of rent buys (`09-security-model.md` §9.7.4.2 R9). |
