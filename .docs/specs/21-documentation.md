...
| 16 | Domain separators | §9.18.2 | 35 separators registered (incl. distinct sync-delta `SCP-CONTEXT-SNAPSHOT-V2:` and signed-export `SCP-CONTEXT-EXPORT-V2:`), code-verified |
