...
Tier-1 validation (§7.2.1) has two callers with different needs, and the protocol exposes a distinct operation for each. They run the **same** 11 checks; they differ in what they return and in their side effects. (Decision: ADR-057.)
