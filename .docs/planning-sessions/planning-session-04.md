...
> date this file carries, restored unedited. The identity model it reads — did:dht, did:web, did:key, the DID document and its verification methods, the Mainline distributed hash table and the identifier written as a `did:` string — was
