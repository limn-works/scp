...
- [PR #2366 attestation fail-closed](pr2366-attestation-fail-closed.md) — UNSOUND in part; §18.2.2 revocation-endpoint check missing while "every §3.5.4 step" claimed; 3 wrappers excluded on file-ownership; matrix kotlin cell lies; class-2 false; gate regex renamed prod fns.
