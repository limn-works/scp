---
name: surfaces-early-audits
description: Attack surfaces found in PR #76 bridge claiming and FFI skeleton, spec 22 human-readable addressing, and the PR #127 UCAN bridge second pass, plus what held up
metadata:
  type: project
---
