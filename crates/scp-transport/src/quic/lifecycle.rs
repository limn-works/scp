...
//!   parameters. [`ReconnectBackoff`] implements the exponential backoff
//!   strategy with min/max bounds from [`TransportProfile`](crate::TransportProfile).
//!
...
/// Exponential backoff for QUIC reconnection, parameterized by transport
...
mod tests {
    ...
    #[test]
    fn backoff_from_server_profile() {
    ...
    #[test]
    fn backoff_from_desktop_profile() {
    ...
    #[test]
    fn backoff_from_mobile_profile() {
    ...
    #[test]
    fn backoff_from_constrained_profile() {
    ...
    fn backoff_exponential_growth() {
        ...
        assert!(d3 < Duration::from_secs(6));
    }
    ...
    fn backoff_caps_at_max() {
        ...
        let _d3 = backoff.next_delay(); // 4s (at cap)
    ...
    #[test]
    fn backoff_mobile_profile_range() {
        ...
        assert!(d2 < Duration::from_secs(14));
    }
