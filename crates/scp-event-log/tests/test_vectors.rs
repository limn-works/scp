...
///
/// Spread (ADR-011 Amendment coverage): `SpendApproved`,
...
fn kat_events() -> Vec<Event> {
    ...
    // documented bytes. Spread covers SpendApproved, TtlExtended,
...
fn vector_32_typed_leaf_and_checkpoint_kat() {
    ...
    assert_eq!(events.len(), 8, "KAT spread must be 8 events");
    ...
    let expected_leaves = [
        // 0: SpendApproved
        "6a202edba387e4795a56e88bf2f9cf0d02ad27ccdba46254c56e9c08e7e3bfa8",
        // 1: TtlExtended
        "00d2fde09a56c927e9748c393182b2acdee77a333f9687f55bc2632a53237a0d",
        // 2: RecoveryEpochAdvanced
        "2d16b88f5026910e289c5769873960cf43dfe332c14c127d611dbcd298dcd04a",
        // 3: ContextTombstoned
        "85498ec404b462b0991151aa7a9ec4dced1ae412446ecf8bd299f4b1fed4a691",
        // 4: ConsequenceTriggered
        "73b2a74256b07c46bc4dd0f6b841b608c85ed8ec476704a084779931241275b1",
        // 5: CommitBroadcastSucceeded
        "1ee12b6fbda50bb4c8633061f282db9cf8446fbb18202186118a97d186105477",
        // 6: RoleAssigned (RoleAssignedPayload)
        "2d4d7f59f2dac77bf2fbb298bee38118ce5ead2949b3944bc4c3ad14987a1edc",
        // 7: MemberJoined (MembershipChangePayload)
        "f25c8cc0313555052cf50f67dcf59187a05ebb35e40c530581c70c4709e1846d",
    ];
    for (i, leaf) in leaves.iter().enumerate() {
    ...
    assert_eq!(
        hex(&root),
        "70a0b90909fa9f9432799bc6589f9b7cc63162995c8b2c68f0194aefa9183468",
        "tree::root mismatch"
    );
}
...
async fn vector_33_checkpoint_root_equals_tree_root_kat() {
    ...
    assert_eq!(cp.event_count, 8, "checkpoint must cover all 8 events");
