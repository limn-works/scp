...
/// - [`crate::resolution::verify_relay_record`] (relay + dual-layer resolution path)
///
/// # Errors
///
...
/// — [`DidDht::resolve_did`] or [`crate::resolution::verify_relay_record`] —
/// so the document's BEP44
