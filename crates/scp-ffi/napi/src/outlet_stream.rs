...
//! - [`outlet_stream_poll_next_on`] — drain one item: a chunk, a thrown
...
/// `None` once the channel has closed. This is the primitive the TypeScript
...
impl crate::scp::Scp {
    ...
    /// registry entry, `outlet_stream_poll_next_on`, the error it constructs,
