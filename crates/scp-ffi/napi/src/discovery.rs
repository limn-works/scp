...
mod tests {
    ...
    fn petname_set_and_resolve() {
        ...
        crate::scp::Scp::new()
            ...
            .unwrap();
        let json = crate::scp::Scp::new()
            .unwrap()
            .petname_resolve_did(owner, "alice".to_owned())
            .unwrap();
    ...
    fn petname_context_set_and_resolve() {
        ...
        crate::scp::Scp::new()
            .unwrap()
            .petname_set_context(owner.clone(), "ctx-napi-1".to_owned(), "work".to_owned())
            .unwrap();
        let json = crate::scp::Scp::new()
            .unwrap()
    ...
    fn handle_register_and_lookup_napi() {
        ...
        let lookup = crate::scp::Scp::new()
            .unwrap()
            .handle_lookup(ctx, "alice".to_owned(), None)
            .unwrap();
