...
pub use context::outlets::error_codes::{
    ...
    CODE_EXECUTION_STREAM_CAP, CODE_GOVERNANCE_FAULT, CODE_INPUT_VIOLATION, CODE_OUTPUT_VIOLATION,
    CODE_PROTOCOL_SESSION, CODE_PROTOCOL_VIOLATION, CODE_TRANSPORT_FAULT,
    SLUG_PROTOCOL_UNKNOWN_SESSION, SlugError, error_code_to_class, error_code_to_default_slug,
    error_code_to_retry_policy, slug_to_class, validate_slug,
};
