...
- **Never use "the" on a noun you have not already used.**
...
- **Nine forbidden constructions.** Each one substitutes a rhetorical move for a claim. Delete it and write the claim.
...
- **Check every sentence before you send it.** Ask seven questions: have I hidden a subordinate relation? Have I dropped a subject or an object? Does a passive verb hide who acted? Have I appraised the work instead of reporting it? Have I referenced anything by a bare identifier? Have I used any of the nine forbidden constructions? Does this sentence admit two contradictory readings? If any answer is yes, rewrite the sentence.
