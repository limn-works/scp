...
- **Write the shortest sentence that still obeys every rule above.** Delete a word when deleting it takes no agent, no object, no denominator, and no connective out of the sentence. Delete preamble, restatements of the question you were asked, narration of your own process, hedges, and praise. Never shorten a sentence by deleting its subject, its object, or the word that states how its clauses relate. When you cannot shorten a sentence without deleting one of those three, leave the sentence long.
- **Check every sentence before you send it.** Ask three questions: have I hidden a subordinate relation? Have I dropped a subject or an object? Does this sentence admit two contradictory readings? If any answer is yes, rewrite the sentence.
