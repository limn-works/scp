...
- **Spend as few words as the rules above allow.** Cut every word whose deletion removes no agent, no object, no denominator, and no causal connective. Delete preamble, restatement of the question, self-narration, hedges, and praise. Concision never buys itself by dropping a subject, an object, or a stated relation — when brevity and concreteness conflict, concreteness wins and the sentence gets longer.
