...
class SCP:
    ...
    def identity_verify_device_attestation(self, _did: Any, token_base64: Any) -> Any: ...
    def py_verify_identity_link_attestation(
        self, attestation_json: Any, issuer_public_key_hex: Any
    ) -> Any: ...
    ...
    def provenance_check_chain_depth(self, chain_depth: Any, max_depth: Any = ...) -> Any: ...
    def provenance_pseudonymize_counterparties(
        self, provenance_json: Any, pseudonym_key_hex: Any
    ) -> Any: ...
    def provenance_redact_counterparties(self, provenance_json: Any) -> Any: ...
    def provenance_update_source_type(self, provenance_json: Any, new_state: Any) -> Any: ...
    ...
    # -- scpid --
    def scpid_challenge(self, audience: Any, ttl_seconds: Any) -> Any: ...
...
# -- MCP stdio allowlist (#1543 PR-D: methods on SCP, not module-level) --
# The four `py_mcp_*_stdio_allowlist` free functions were deleted in
# #1543 PR-D — see `class SCP` above for the per-instance method stubs.
