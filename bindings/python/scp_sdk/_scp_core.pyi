...
class SCP:
    ...
    def py_mcp_client_invoke(
        self, handle: Any, tool_name: Any, input: Any, context_id: Any, identity_did: Any
    ) -> Any: ...
    ...
    def tool_interface_expose(
        self, context_id: Any, tool_id: Any, target_context_id: Any, rate_limit_json: Any = ...
    ) -> Any: ...
    ...
    def tool_session_create(
        self, context_id: Any, tool_id: Any, source_context_id: Any, ttl_seconds: Any = ...
    ) -> Any: ...
