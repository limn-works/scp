...
//   2. Generate Kotlin bindings: ./gradlew :scp-sdk-kotlin:generateUniffiBindings
//   3. Run: ./gradlew :scp-sdk-kotlin:test --tests "com.limn.scp.RealFFITest"
//
    ...
    companion object {
        ...
        fun checkNativeLibrary() {
            try {
                ...
                Class.forName("com.limn.scp.internal.NativeLib")
