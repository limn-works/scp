...
class ConformanceDispatcher(
    ...
    ): Map<String, String> = when (operation) {
    ...
    private suspend fun dispatchIdentityLoad(
        input: Map<String, String>,
    ): Map<String, String> = catchBridge {
        val did = input["did"] ?: ""
    ...
    private suspend fun dispatchIdentityResolve(
        input: Map<String, String>,
    ): Map<String, String> = catchBridge {
        val did = input["did"] ?: ""
    ...
    private suspend fun dispatchContextCreate(
        input: Map<String, String>,
    ): Map<String, String> = catchBridge {
    ...
    private suspend fun dispatchContextClose(
        input: Map<String, String>,
    ): Map<String, String> = catchBridge {
        val contextHandle = input["context_handle"]?.toLongOrNull() ?: 0L
        val identityHandle = input["identity_handle"]?.toLongOrNull() ?: 0L
    ...
    private suspend fun dispatchContextSend(
        input: Map<String, String>,
    ): Map<String, String> = catchBridge {
        val contextHandle = input["context_handle"]?.toLongOrNull() ?: 0L
        val identityHandle = input["identity_handle"]?.toLongOrNull() ?: 0L
    ...
    private suspend fun dispatchToolRegister(
        input: Map<String, String>,
    ): Map<String, String> = catchBridge {
        val contextHandle = input["context_handle"]?.toLongOrNull() ?: 0L
    ...
    private suspend fun dispatchToolInvoke(
        input: Map<String, String>,
    ): Map<String, String> = catchBridge {
        val contextHandle = input["context_handle"]?.toLongOrNull() ?: 0L
    ...
    private suspend fun dispatchTransportConnect(
        input: Map<String, String>,
    ): Map<String, String> = catchBridge {
