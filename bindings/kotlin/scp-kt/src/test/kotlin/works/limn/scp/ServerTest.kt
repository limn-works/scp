...
internal class StubServerBindings : ServerBindings {
    ...
    override fun nodeStartInMemory(identityJson: String?): String = nodeStartInMemoryResult
    override fun nodeStartLocal(dataDir: String, identityJson: String?): String = nodeStartInMemoryResult
