...
// `McpServerConfig` is generated by UniFFI in `ScpBindings.swift`.
// Fields: `identityDid`, `contextIds`, `transport` (String: "stdio"/"sse"),
// `ucanToken` (String?), `proofTokens` ([String]?).
